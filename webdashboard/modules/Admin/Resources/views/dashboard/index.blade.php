...
@section('content')
    <div class="dashboard-container">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single-grid total-sales">
                        <div>
                            ...
                            <span class="title">{{ trans('admin::dashboard.total_comments') }}</span>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single-grid total-orders">
                        <div>
                            ...
                            <span class="title">{{ trans('admin::dashboard.total_platforms') }}</span>
                        </div>
                        <div class="single-grid-icon">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single-grid total-products">
                        <div>
                            ...
                            <span class="title">{{ trans('admin::dashboard.total_feedbacks') }}</span>
                        </div>
                        <div class="single-grid-icon">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="single-grid total-customers">
                        <div>
                            <span class="count" id="total-customers">4</span>
                            <span class="title">{{ trans('admin::dashboard.total_users') }}</span>
                        </div>
                        <div class="single-grid-icon">
        ...
        <!-- Comment Labels Distribution and Latest Logs Section -->
        <div class="row mt-4">
            <!-- Comment Labels Distribution -->
            <div class="col-md-8">
                <div class="box product-price-chart">
                    <div class="box-header with-border">
                        <h3 class="box-title">{{ trans('admin::dashboard.comment_label_chart.title') }}</h3>
                    </div>
                    <div class="box-body">
            ...
            <div class="col-md-4">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">{{ trans('admin::dashboard.latest_logs.title') }}</h3>
                    </div>
                    <div class="box-body">
                            ...
                            <table id="latest-brands-table" class="table table-borderless">
                                <thead>
                                    <tr class="brands-header">
                                        <th>{{ trans('admin::dashboard.latest_logs.log_id') }}</th>
                                        <th>{{ trans('admin::dashboard.latest_logs.user_id') }}</th>
                                        <th>{{ trans('admin::dashboard.latest_logs.action') }}</th>
                                        <th>{{ trans('admin::dashboard.latest_logs.timestamp') }}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td colspan="4" class="text-center no-data">Loading logs...</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
        ...
        <!-- Latest Comments and Latest Users Section -->
        <div class="row mt-4">
            <!-- Latest Comments -->
            <div class="col-md-8">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">{{ trans('admin::dashboard.latest_comments.title') }}</h3>
                    </div>
                    <div class="box-body">
                        <div class="table-responsive">
                            <table id="latest-products-table" class="table table-borderless">
                                <thead>
                                    <tr class="products-header">
                                        <th>{{ trans('admin::dashboard.latest_comments.content') }}</th>
                                        <th>{{ trans('admin::dashboard.latest_comments.platform') }}</th>
                                        <th>{{ trans('admin::dashboard.latest_comments.prediction') }}</th>
                                        <th>{{ trans('admin::dashboard.latest_comments.confidence') }}</th>
                                        <th>{{ trans('admin::dashboard.latest_comments.status') }}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td colspan="5" class="text-center no-data">Loading comments...</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
