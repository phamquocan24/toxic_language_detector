...
class UserController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('user::admin.users.index', compact('users', 'sortBy', 'sortOrder', 'perPage', 'search', 'totalUsers', 'roles', 'showDelete'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $redirectRoute = $request->input('redirect_after_save') == '1' ? 'admin.users.index' : 'admin.users.edit';

        return redirect()->route($redirectRoute, $redirectRoute == 'admin.users.edit' ? $user->id : null)
            ->with('success', trans('user::users.messages.created'));
    }
