...
$(function () {
    ...
    var o = $.Ecommerce.options;

    // Set up the object
    _init();

    // Activate layout
    $.Ecommerce.layout.activate();

    // Enable sidebar tree view controls
    if (o.enableControlTreeView) {
        $.Ecommerce.tree(".sidebar");
    }

    // Activate sidebar push menu
    if (o.sidebarPushMenu) {
        $.Ecommerce.pushMenu.activate(o.sidebarToggleSelector);
    }
...
function _init() {
    ...
    $.Ecommerce.pushMenu = {
        activate: function (toggleBtn) {
            var screenSizes = $.Ecommerce.options.screenSizes;
    ...
    // Tree
    $.Ecommerce.tree = function (menu) {
        var animationSpeed = $.Ecommerce.options.animationSpeed;
