...
@component('admin::components.page.header')
    @slot('title', trans('admin::resource.create', ['resource' => trans('category::categories.categories')]))

    <li><a href="{{ route('admin.categories.index') }}">{{ trans('category::categories.categories') }}</a></li>
    <li class="active">{{ trans('admin::resource.create', ['resource' => trans('category::categories.categories')]) }}</li>
@endcomponent
            ...
            <div class="box-body">
                <div class="tab-pane fade in active" id="general">
                    ...
                    <div id="id-field" class="form-group hide">
                        ...
                        <div class="col-md-9">
                            <input name="id" class="form-control" id="id" type="text" value="{{ old('id') }}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <div class="checkbox">
                                ...
                                <input type="checkbox" name="is_searchable" class="" id="is_searchable" value="1" {{ old('is_searchable') ? 'checked' : '' }}>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <div class="checkbox">
                                ...
                                <input type="checkbox" name="is_active" class="" id="is_active" value="1" {{ old('is_active') ? 'checked' : '' }}>
